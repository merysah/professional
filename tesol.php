...
<div class="container-fluid p-0">
  ...
  <section>
    ...
    <div class="row w-75 mx-auto">
      <div class="col-xl-3 col-md-4 col-12 my-2 my-lg-5 shadow position-relative card rounded-15 offset-xl-2 offset-md-1">
        ...
        <p class="text-center fs-2 mt-5">Exam cost</p>
        <div class="text-center fs-1 mb-3">65$</div>
        ...
        <img src="<?= img.'cost-bottom-img.png' ?>" class="w-25 position-absolute bottom-10" alt="">
      </div>

      <div class="col-xl-3 col-md-4 col-12 my-2 my-lg-5 shadow position-relative card rounded-15 offset-xl-2 offset-md-2">
        <div class="bg-grey mx-auto text-center px-3 py-1 rounded-15 mt-3 mb-5">
          Annual payment (optional)
        </div>
        <p class="text-center fs-2 mt-5">Price:</p>
        <div class="text-center fs-1 mb-3">650$</div>
        <a href="" class="btn btn-danger w-50 mx-auto rounded-25 fs-3 mt-5 mb-2 javanese">Choose</a>
        <img src="<?= img.'cost-top-img.png' ?>" class="w-25 position-absolute end-0" alt="">
        <img src="<?= img.'cost-bottom-img.png' ?>" class="w-25 position-absolute bottom-10" alt="">
      </div>
  ...
  <section>
    ...
    <div class="w-75 my-md-5 mx-auto bg-white border-0 rounded-25 d-flex exam-elements">
      <div>
        <ul class="lst-none overview-listing p-0">
          <li class="fs-3 my-1">Classroom Management</li>
          <li class="fs-3 my-1">Teaching Methodology</li>
          <li class="fs-3 my-1">Cultural Sensitivity</li>
          <li class="fs-3 my-1">Teaching Pronunciation</li>
          <li class="fs-3 my-1">Teaching Vocabulary</li>
          <li class="fs-3 my-1">Learner Differences</li>
          <li class="fs-3 my-1">Teaching in Different Contexts</li>
          <li class="fs-3 my-1">Legal matters and protection of minors</li>
          <li class="fs-3 my-1">TEFL E-books and Digital Texts</li>
        </ul>
      </div>
      <div>
        <ul class="lst-none overview-listing p-0">
          <li class="fs-3 my-1">Foundations of Language Teaching</li>
          <li class="fs-3 my-1">Language Awareness</li>
          <li class="fs-3 my-1">Error Correction</li>
          <li class="fs-3 my-1">Lesson Planning</li>
          <li class="fs-3 my-1">Teaching Pronunciation</li>
          <li class="fs-3 my-1">Teaching Speaking and Reading</li>
          <li class="fs-3 my-1">Assessment and Testing</li>
          <li class="fs-3 my-1">TEFL Teaching Aids</li>
        </ul>
      </div>
    </div>
      ...
      <table class="table table-borderless exam-table">
        <thead>
          <tr class="">
            ...
            <th scope="col" class="col-3 javanese border-bottom-blue2">Exam</th>
            <th scope="col" class="col-3 javanese border-bottom-blue2">Digital Badge Credential</th>
            <th scope="col" class="col-3 javanese border-bottom-blue2">International License</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td class="text-capitalize">Pass Certificate</td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Online Verification</td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Webinars and workshops</td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Employers Fair participation</td>
            <td align="center"><img src="<?= img.'Cross-mark.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Online Link Verification</td>
            <td align="center"><img src="<?= img.'Cross-mark.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Global Register Profile</td>
            <td align="center"><img src="<?= img.'Cross-mark.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Global Register job search</td>
            <td align="center"><img src="<?= img.'Cross-mark.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Global Register Clients search</td>
            <td align="center"><img src="<?= img.'Cross-mark.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
          <tr>
            <td class="text-capitalize">Wear it with pride</td>
            <td align="center"><img src="<?= img.'Cross-mark.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Cross-mark.png' ?>" width="20" alt=""></td>
            <td align="center"><img src="<?= img.'Tick-symbol.png' ?>" width="20" alt=""></td>
          </tr>
    ...
    <div class="my-md-5 w-75 mx-auto border-blue rounded-25 py-2">
      <ul>
        <li>Taking the exam is <strong>mandatory</strong> to obtain the Digital Badge Credential and the international license.</li>
        <li>While both the DBC and the IL are optional, if you receive the International License from Cambridge Royal Academy, you will also be granted the Digital Badge Credential by Manchester Exam free of charge.</li>
      </ul>
    </div>
  </section>
