...
<div class="container">
  ...
  <section>
    ...
    <div class="box w-90 mx-auto border border-blue rounded-25 bg-white px-4 py-2 fs-3 row">
      ...
      <div class="col-md-6 col-md-end"><span class="fw-bold">Cost : </span>$ 50</div>
  ...
  <section>
    ...
    <div class="my-md-5 w-90 mx-auto">
      <ul class="lst-none overview-listing">
        ...
        <li class="fs-3 my-1">
          Gain a <span class="fw-bold">Digital Badge Credential</span>
        </li>
        <li class="fs-3 my-1">
    ...
    <div class="my-5">
      ...
      <div class="row align-items-center mx-3">
        ...
        <div class="col-9">
          ...
          <p class="text-justify fs-3">Gain a Digital Badge of Excellence (DBE) : The DBE serves as a powerful verification tool, enhancing the credibility of your CV and showcasing your skills to potential employers. Visit DBE page</p>
        </div>
      </div>
      <div class="row align-items-center mx-3">
        <div class="col-9">
