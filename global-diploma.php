...
<div class="container-fluid p-0">
  ...
  <section>
    ...
    <div class="my-md-5 w-75 mx-auto">
      <ul class="lst-none overview-listing p-0">
        ...
        <li class="fs-3 my-1">Internationally recognized.</li>
        <li class="fs-3 my-1">Equivalent to an associate degree or higher national diploma.</li>
        <li class="fs-3 my-1">It helps you advance your career.</li>
        <li class="fs-3 my-1">Cost of the Degree is $ 495 only.</li>
      </ul>
    </div>
    <div class="text-center mt-3">
      <img src="<?= img.'section-bottom.png' ?>" alt="" class="section_bottom_img">
  ...
  <section class="bottom-section">
    ...
    <div class="my-5 w-70 mx-auto">
      ...
      <div class="">
        <p class="title text-center w-75 mx-auto text-blue2 javanese text-uppercase fs-2">It is a Professional degree</p>
        <p class="text-justify fs-3">This means that your diploma is equivalent to a college degree. This can help you earn a higher salary and gain more opportunities in your career.</p>
      </div>
      <div class="">
        <p class="title text-center w-75 mx-auto text-orange javanese text-uppercase fs-2">It is internationally recognized</p>
        <p class="text-justify fs-3">This means that your diploma is accepted by employers and educational institutions around the world. This can give you the freedom to work or study anywhere in the world.</p>
      </div>
      <div class="">
        <p class="title text-center w-75 mx-auto text-purple javanese text-uppercase fs-2">It is equivalent to an associate degree or higher national diploma.</p>
        <p class="text-justify fs-3">This means that your diploma is equal in value to a two-year associate degree or a higher national diploma. This can help you advance your career and earn a higher salary.</p>
      </div>
      <div class="">
        <p class="title text-center w-75 mx-auto text-red javanese text-uppercase fs-2">It can help you advance your career.</p>
        <p class="text-justify fs-3">A global British diploma can help you advance your career by giving you the skills and knowledge you need to succeed in the workplace. It can also help you stand out from other candidates when applying for jobs.</p>
      </div>
    </div>
    <div class="text-center mt-3">
      <img src="<?= img.'section-bottom.png' ?>" alt="" class="section_bottom_img">
